...
pub struct Texts {
    ...
    pub field_titan_startup: &'static str,
    pub field_titan_idle: &'static str,
...
impl Texts {
    pub const ZH: Self = Self {
        ...
        field_language: "语言",
        field_theme: "主题",
        field_titan_startup: "启动动画",
        field_titan_idle: "空对话泰坦",
        field_whimsy: "输入框星空",
        value_on: "开",
        value_off: "关",
...
只输出标题本身，不要解释、引号或标点。",
    ...
    pub const EN: Self = Self {
        ...
        field_theme: "Theme",
        field_titan_startup: "Startup Intro",
        field_titan_idle: "Idle Titan",
...
Output only the title itself: no explanations, quotes, or punctuation.",
    ...
    pub fn field_label(&self, field: SettingsField) -> &'static str {
        match field {
            ...
            SettingsField::TitanStartup => self.field_titan_startup,
            SettingsField::TitanIdle => self.field_titan_idle,
