...
impl Texts {
    pub const ZH: Self = Self {
        ...
        picker_session_hint: "Enter 应用到会话 · a 新增 · d 删除 · Tab 供应商 · Esc 关闭",
        picker_turn_title: "下一轮临时模型",
        picker_turn_hint: "Enter 仅下一轮 · a 新增 · d 删除 · Tab 供应商 · Esc 关闭",
...
只输出标题本身，不要解释、引号或标点。",
    ...
    pub const EN: Self = Self {
        ...
        picker_session_hint: "Enter Apply to Session · a Add · d Delete · Tab Provider · Esc Close",
        picker_turn_title: "Next-turn Model",
        picker_turn_hint: "Enter Next Turn Only · a Add · d Delete · Tab Provider · Esc Close",
